...
/**
 * <p>ServiceItemType complex type的 Java 类。
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="option" type="{http://jsfboot.easyeip.com/jsfboot-module}ServiceOptionType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class ServiceItemType {
    ...
    protected List<ServiceOptionType> option;
     ...
     * 
     */
    public List<ServiceOptionType> getOption() {
        if (option == null) {
            option = new ArrayList<ServiceOptionType>();
        }
        return this.option;
    }
