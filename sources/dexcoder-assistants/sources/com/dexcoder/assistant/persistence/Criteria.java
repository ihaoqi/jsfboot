...
public class Criteria {
    ...
    public Criteria clone (){
    	Criteria newcr = new Criteria(entityClass);
    	
    	newcr.isWhere = this.isWhere;
    	newcr.autoFields.addAll(this.autoFields);
    	newcr.orderByFields.addAll(this.orderByFields);
    	
    	if (this.includeFields != null){
    		newcr.includeFields = new ArrayList<String>();
    		newcr.includeFields.addAll(this.includeFields);
    	}
    	
    	if (this.excludeFields != null){
    		newcr.excludeFields = new ArrayList<String>();
    		newcr.excludeFields.addAll(this.excludeFields);
    	}
    	return newcr;
    }
     ...
     * @return
     */
    public Criteria and (Criteria subexpr){
        AutoField autoField = this.buildAutoFields(null, "and", null,
                AutoField.WHERE_FIELD, new Object[]{subexpr});
            this.autoFields.add(autoField);
            return this;
    }
     ...
     * @return
     */
    public Criteria or (Criteria subexpr){
        AutoField autoField = this.buildAutoFields(null, "and", null,
                AutoField.WHERE_FIELD, new Object[]{subexpr});
            this.autoFields.add(autoField);
            return this;
     ...
     * @return
     */
    public Criteria where (Criteria subexpr){
    	if (this.isWhere) {
            throw new AssistantException("There can be only one 'where'!");
        }
        AutoField autoField = this.buildAutoFields(null, null, null,
                AutoField.WHERE_FIELD, new Object[]{subexpr});
        this.autoFields.add(autoField);
        this.isWhere = true;
        return this;
